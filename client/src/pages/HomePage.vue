  ...
  <div class="container-fluid">
    <section class="row justify-content-between">
      ...
      <div class="col-4 col-md-2 fs-3 text-white text-center mt-3">
        <button class="mb-2 transparent-bg rounded text-white btn btn fs-5" data-bs-toggle="modal" data-bs-target="#FilterCars">Filter<i class="mdi mdi-filter"></i></button>
